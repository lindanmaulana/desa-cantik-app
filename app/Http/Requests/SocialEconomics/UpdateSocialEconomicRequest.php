...
class UpdateSocialEconomicRequest extends FormRequest
{
    /**
    ...
    {
        $socialEconomic = $this->route('social_economic');
        $id = $socialEconomic instanceof SocialEconomic ? $socialEconomic->id : $socialEconomic;
        ...
        return [
            'citizen_id' => [
                ...
                Rule::unique('social_economics', 'citizen_id')->ignore($id)->whereNull('deleted_at'),
            ],
            'education_level' => [
                'required',

<aside
    class="h-full overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] transition-all duration-500 ease-in-out border-r bg-primary text-slate-300 shrink-0 border-tertiary"
    ...
    <div class="sticky top-0 z-10 flex items-center h-16 p-4 text-white transition-all duration-500 border-b-2 border-tertiary bg-primary"
        ...
        <span class="ml-3 text-sm font-bold tracking-wider uppercase truncate origin-left transform whitespace-nowrap"
    ...
    <nav class="flex flex-col w-full gap-2 px-4 mt-6 text-base">
        ...
        <a href="{{ route('dashboard') }}"
            class="flex items-center px-4 py-3 rounded-lg transition-all duration-300 {{ request()->routeIs('dashboard') ? 'bg-secondary text-white border-l-4 rounded-l-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }}"
        ...
        <div class="relative space-y-2">
            <button
                @click="if(!openSidebar) { openSidebar = true; openStatistik = true; } else { openStatistik = !openStatistik; }"
                class="flex items-center w-full px-4 py-3 transition-all duration-300 rounded-lg text-slate-300 hover:bg-secondary hover:text-white"
                ...
                <div class="flex items-center min-w-0">
                    ...
                    <span class="ml-3 font-medium truncate origin-left transform whitespace-nowrap"
                        x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                            'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                        Statistik
                    </span>
                ...
                <x-uiw-up class="w-4 h-4 transition-all duration-300 origin-center shrink-0"
                    x-bind:class="[openStatistik && openSidebar ? 'rotate-180' : '', openSidebar ? 'opacity-100 scale-100' :
                        'opacity-0 scale-0 absolute invisible'
                    ]" />
            </button>

            <div x-show="openStatistik && openSidebar" x-collapse x-cloak x-init="$el.classList.remove('hidden')"
                class="hidden font-medium border-l border-tertiary/50 ml-4 pl-2 space-y-2">
                ...
                <a href="{{ route('dashboard.statistics.demograph') }}"
                    ...
                    <span class="truncate origin-left transform whitespace-nowrap">Demografi</span>
                </a>
                ...
                <a href="{{ route('dashboard.statistics.social') }}"
                    ...
                    <span class="truncate origin-left transform whitespace-nowrap">Sosial</span>
                </a>
                ...
                <a href="{{ route('dashboard.statistics.economy') }}"
                    ...
                    <span class="truncate origin-left transform whitespace-nowrap">Ekonomi</span>
                </a>

                <a href="{{ route('dashboard.statistics.msme') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.statistics.msme') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-bi-shop class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Umkm</span>
                </a>

                <a href="{{ route('dashboard.statistics.infrastructure') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.statistics.infrastructure') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-bi-building-gear class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Infrastruktur</span>
                </a>

                <a href="{{ route('dashboard.statistics.spatial-data') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.statistics.spatial-data') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-iconsax-out-map class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Data Spasial</span>
                </a>
            </div>
        </div>
        ...
        <div class="relative space-y-2">
            <button
                @click="if(!openSidebar) { openSidebar = true; openManageData = true; } else { openManageData = !openManageData; }"
                class="flex items-center w-full px-4 py-3 transition-all duration-300 rounded-lg text-slate-300 hover:bg-secondary hover:text-white"
                x-bind:class="openSidebar ? 'justify-between' : 'justify-center'">
                <div class="flex items-center min-w-0">
                ...
                <x-uiw-up class="w-4 h-4 transition-all duration-300 origin-center shrink-0"
                    x-bind:class="[openManageData && openSidebar ? 'rotate-180' : '', openSidebar ? 'opacity-100 scale-100' :
                        'opacity-0 scale-0 absolute invisible'
                    ]" />
            </button>

            <div x-show="openManageData && openSidebar" x-collapse x-cloak x-init="$el.classList.remove('hidden')"
                class="hidden font-medium border-l border-tertiary/50 ml-4 pl-2 space-y-2">
                ...
                <a href="{{ route('dashboard.manage-data.territories') }}"
                    ...
                    <span class="truncate origin-left transform whitespace-nowrap">Data Wilayah</span>
                </a>

                <a href="{{ route('dashboard.manage-data.families') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.manage-data.families') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-iconsax-bro-user-add class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Data Keluarga</span>
                </a>
                ...
                <a href="{{ route('dashboard.manage-data.citizens') }}"
                    ...
                    <span class="truncate origin-left transform whitespace-nowrap">Data Penduduk</span>
                </a>
                ...
                <a href="{{ route('dashboard.manage-data.social-economics') }}"
                    ...
                    <x-ri-heart-pulse-line class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Sosial Ekonomi</span>
                </a>
                ...
                <a href="{{ route('dashboard.manage-data.msmes') }}"
                    ...
                    <x-bi-shop class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Data UMKM (MSMEs)</span>
                </a>

                <a href="{{ route('dashboard.manage-data.infrastructures') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.manage-data.infrastructures') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-iconsax-lin-buildings class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Data Infrastruktur</span>
                </a>

                <a href="{{ route('dashboard.manage-data.spatial-data') }}"
                    class="flex items-center gap-2 px-4 py-2 text-sm transition-all duration-300 {{ request()->routeIs('dashboard.manage-data.spatial-data') ? 'bg-secondary text-white border-l-4 rounded-l-md ml-1 rounded-r-md' : 'text-slate-300 hover:bg-secondary hover:text-white' }} justify-start pl-4">
                    <x-iconsax-lin-map class="transition-all duration-500 size-5 shrink-0" />
                    <span class="truncate origin-left transform whitespace-nowrap">Data Spasial (GIS)</span>
                </a>
            </div>
        </div>

        <a href="{{ route('dashboard.pandawa-analysis') }}"
            class="flex items-center px-4 py-3 transition-all duration-300 rounded-lg {{ request()->routeIs('dashboard.pandawa-analysis') ? 'bg-secondary text-white' : 'text-slate-300 hover:bg-secondary hover:text-white' }}"
            x-bind:class="openSidebar ? 'justify-start' : 'justify-center'">
        ...
        @auth
            <form method="POST" action="{{ route('auth.logout') }}" class="w-full">
                @csrf
                <button type="submit"
                    class="flex items-center w-full px-4 py-3 text-red-800 transition-all duration-300 rounded-lg hover:bg-red-800 hover:text-white"
                    x-bind:class="openSidebar ? 'justify-start' : 'justify-center'">

<aside
    class="h-full overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] transition-all duration-300 ease-in-out border-r bg-primary text-slate-300 shrink-0 border-tertiary fixed top-0 left-0 z-50 w-64 transform -translate-x-full md:relative md:translate-x-0 md:w-64"
    x-bind:class="{
    ...
    <div class="sticky top-0 z-10 flex items-center h-16 p-4 text-white transition-all duration-500 border-b-2 border-tertiary bg-primary"
        ...
        <button @click="openSidebar = false" class="text-slate-400 hover:text-white md:hidden">

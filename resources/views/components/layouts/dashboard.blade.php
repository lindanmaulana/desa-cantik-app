<x-layouts.app>
    <div class="flex h-screen overflow-hidden" x-data="{ openStatistik: {{ request()->routeIs('dashboard.statistics.*') ? 'true' : 'false' }}, openSidebar: true }">
        ...
        <aside
            ...
            <div class="sticky top-0 z-10 flex items-center h-16 p-4 text-white border-b-2 border-third bg-primary transition-all duration-500"
                ...
                <span class="text-sm font-bold tracking-wider uppercase ml-3 truncate transform origin-left"
            ...
            <nav class="flex flex-col w-full gap-2 px-4 mt-6 text-base">
                ...
                <a href="{{ route('dashboard') }}"
                    ...
                    <x-untitledui-home-line class="size-5 shrink-0 transition-all duration-500" />
                    <span class="ml-4 truncate transform origin-left"
                        x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                            'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                        Beranda
                    </span>
                ...
                <div class="relative">
                    <button @click="openStatistik = !openStatistik"
                        ...
                        <div class="flex items-center min-w-0">
                            <x-bx-line-chart class="w-5 h-5 shrink-0 transition-all duration-500" />
                            <span class="font-medium ml-3 truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Statistik
                            </span>
                    ...
                    <div x-show="openStatistik" x-collapse
                        class="font-medium border-l border-third/50 transition-all duration-500"
                        ...
                        <a href="{{ route('dashboard.statistics.demograph') }}"
                            ...
                            <x-ionicon-people-sharp class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Demografi
                            </span>
                        ...
                        <a href="{{ route('dashboard.statistics.social') }}"
                            ...
                            x-bind:class="openSidebar ? 'justify-start pl-4' : 'justify-center py-3'">
                            <x-ri-heart-pulse-line class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Sosial
                        ...
                        <a href="{{ route('dashboard.statistics.economy') }}"
                            ...
                            x-bind:class="openSidebar ? 'justify-start pl-4' : 'justify-center py-3'">
                            <x-phosphor-money class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Ekonomi
                        ...
                        <a href="{{ route('dashboard.statistics.msme') }}"
                            ...
                            x-bind:class="openSidebar ? 'justify-start pl-4' : 'justify-center py-3'">
                            <x-bi-shop class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Umkm
                        ...
                        <a href="{{ route('dashboard.statistics.infrastructure') }}"
                            ...
                            x-bind:class="openSidebar ? 'justify-start pl-4' : 'justify-center py-3'">
                            <x-bi-building-gear class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Infrastruktur
                        ...
                        <a href="{{ route('dashboard.statistics.spatial-data') }}"
                            ...
                            x-bind:class="openSidebar ? 'justify-start pl-4' : 'justify-center py-3'">
                            <x-iconsax-out-map class="size-5 shrink-0 transition-all duration-500" />
                            <span class="truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Data Spasial
                ...
                <a href="{{ route('dashboard.pandawa-analysis') }}"
                    ...
                    x-bind:class="openSidebar ? 'justify-start' : 'justify-center'">
                    <x-untitledui-star-06 class="size-5 shrink-0 transition-all duration-500" />
                    <span class="ml-4 truncate transform origin-left"
                        x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                            'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                        Pandawa - Analisis
                ...
                @auth
                    <form method="POST" action="{{ route('auth.logout') }}" class="w-full">
                        ...
                        <button type="submit"
                            ...
                            x-bind:class="openSidebar ? 'justify-start' : 'justify-center'">
                            <x-iconsax-out-logout class="size-5 shrink-0 transition-all duration-500" />
                            <span class="ml-4 truncate transform origin-left"
                                x-bind:class="openSidebar ? 'opacity-100 max-w-xs scale-100 transition-all duration-500 delay-200' :
                                    'opacity-0 max-w-0 scale-95 absolute pointer-events-none invisible transition-all duration-150'">
                                Logout
        ...
        <div class="flex flex-col flex-1 h-full min-w-0">
            <header class="flex items-center justify-between h-16 px-8 bg-white border-b-2 border-primary shrink-0">
                ...
                <button
                    class="px-5 py-2 text-sm font-semibold text-white transition rounded-md bg-primary hover:bg-secondary capitalize">
                    {{ Auth::user()->fullname ?? 'Petugas' }}
                </button>
            </header>

            <main class="flex-1 p-8 overflow-y-auto bg-slate-50 container mx-auto">
                {{ $slot ?? '' }}
                @yield('content')
            </main>
        </div>

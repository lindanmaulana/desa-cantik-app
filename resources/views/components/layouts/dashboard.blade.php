<x-layouts.app>
    <div class="flex h-screen overflow-hidden bg-tertiary" x-cloak x-data="{
        ...
        @beforeunload.window="$store.navLoading.start('global-page-load')">
        ...
        <div class="flex flex-col flex-1 h-full min-w-0">
            ...
            <header
                class="flex items-center justify-between h-16 px-8 border-b-2 bg-secondary border-textTertiary/20 shrink-0">

                <button @click="openSidebar = !openSidebar"
                    class="z-30 cursor-pointer text-textSecondary hover:text-primary focus:outline-none">

    ...
    <div class="w-full max-w-xl overflow-hidden transition-all duration-300 transform scale-95 border shadow-xl bg-secondary border-textTertiary/30 rounded-2xl">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-textTertiary/20 bg-tertiary">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h3 class="text-lg font-bold text-textPrimary">Tambah Profil Rumah & Hunian</h3>
                    <p class="text-xs text-textSecondary">Isi data kelayakan hunian, sanitasi, dan fasilitas dasar rumah keluarga.</p>
                </div>
            </div>
        ...
        <form :action="`/housing-profile/{{ $family->id }}/store`"
            method="POST"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label for="floor_area_per_capita" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
                        Luas Lantai Per Kapita <span class="text-red-500">*</span>
                    </label>
                    <select id="floor_area_per_capita" name="floor_area_per_capita" required
                ...
                <div>
                    <label for="floor_material" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label for="wall_material" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div>
                    <label for="water_source" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label for="sanitation_type" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div>
                    <label for="cooking_fuel" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label for="electricity_source" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div>
                    <label for="electricity_capacity" class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="flex items-start gap-2 p-3 text-xs border rounded-lg bg-amber-500/10 border-amber-500/20 text-amber-500">
                <x-heroicon-o-information-circle class="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
                <p>Data profil hunian ini digunakan untuk melengkapi parameter indikator kemiskinan dan kelayakan fasilitas rumah tangga regional desa secara akurat.</p>
            </div>

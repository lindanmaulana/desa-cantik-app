{{-- Modal Konfirmasi Hapus Data Keluarga --}}
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm leading-relaxed text-textSecondary">
                        Apakah Anda yakin ingin menghapus data keluarga dengan Nomor KK <span class="font-semibold text-textPrimary" x-text="family.kk_number"></span> secara permanen? Tindakan ini akan menghapus seluruh data hubungan anggota keluarga, riwayat bantuan sosial, serta dokumentasi kependudukan warga yang terhubung. <span class="font-semibold text-red-500">Aksi ini tidak dapat dibatalkan</span>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t bg-tertiary/40 border-textTertiary/20">
            ...
            <form :action="deleteRoute" method="POST" class="inline" @submit="submitting = true">
                ...
                <button type="submit"
                    ...
                    <span x-text="submitting ? 'Memproses...' : 'Ya, Hapus Keluarga'"></span>
                </button>
            </form>
        </div>
    </div>

<div class="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
    <div class="max-w-2xl">
        ...
        <p class="mt-1 text-sm text-gray-500 max-md:text-xs">Pemetaan dan pendataan kepemilikan usaha mikro, jumlah
            tenaga kerja lokal, serta estimasi omset bulanan warga desa.</p>
    </div>

    <div class="flex items-center gap-2">
        <button @click="openData = !openData"
            class="inline-flex items-center px-4 py-2 text-sm font-medium transition-colors rounded-lg shadow-sm text-secondary bg-textSecondary hover:opacity-90">

<div x-show="openCreate"
    ...
    <div
        class="w-full max-w-2xl overflow-hidden transition-all duration-300 transform scale-95 border shadow-xl bg-secondary border-textTertiary/30 rounded-2xl">
        ...
        <form action="{{ route('msmes.store') }}" method="POST" class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            <div>
                <label for="citizen_id"
                    class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Pemilik Usaha
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    <label for="business_name"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nama Toko /
                ...
                <div>
                    <label for="business_category"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Kategori
                        Bidang
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div class="md:col-span-2">
                    <label for="license_number"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nomor Izin
                        Usaha
                ...
                <div>
                    <label for="employee_count"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Jumlah
                        Karyawan
                        <span class="text-red-500">*</span></label>
                    <input type="number" id="employee_count" name="employee_count" min="0" required
                        placeholder="0"
                        class="w-full px-3 py-2 text-sm transition-all border rounded-lg border-textTertiary/40 bg-tertiary text-textPrimary placeholder:text-textSecondary/50 focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <label for="mothly_revenue"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Estimasi Omset

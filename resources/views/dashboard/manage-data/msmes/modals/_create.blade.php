    ...
    <div class="w-full max-w-2xl overflow-hidden transition-all duration-300 transform scale-95 border shadow-xl bg-secondary border-textTertiary/30 rounded-2xl">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-textTertiary/20 bg-tertiary">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h3 class="text-lg font-bold text-textPrimary">Tambah Profil Usaha UMKM</h3>
                    <p class="text-xs text-textSecondary">Daftarkan usaha produktif lokal milik warga desa.</p>
                </div>
            </div>
        ...
        {{-- Form Konten --}}
        <form action="{{ route('msmes.store') }}" method="POST"
            class="p-6 space-y-4 max-h-[75vh] overflow-y-auto" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf

            {{-- 1. Pemilik Usaha --}}
            <div class="space-y-1">
                <label for="citizen_id" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="space-y-1">
                    <label for="business_name" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div class="space-y-1">
                    <label for="business_category" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div class="space-y-1 md:col-span-2">
                    <label for="license_number" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div class="space-y-1">
                    <label for="employee_count" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="space-y-1">
                    <label for="legal_entity_type" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div class="space-y-1">
                    <label for="monthly_revenue" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
                        Estimasi Omset Bulanan Usaha (Rupiah)
                    </label>
                    <div class="relative">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="space-y-1">
                    <label for="capital_source" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
                ...
                <div class="space-y-1">
                    <label for="digita_platform_type" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="space-y-1">
                <label for="bumdes_partnership_status" class="block text-xs font-semibold tracking-wider uppercase text-textSecondary">
            ...
            <div class="grid grid-cols-1 gap-4 p-4 border border-textTertiary/20 rounded-xl bg-tertiary/50 sm:grid-cols-2">
                <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm">
                        <label for="uses_digital_payment" class="font-medium text-textPrimary">Mendukung Pembayaran Digital</label>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm">
                        <label for="is_environmentally_friendly" class="font-medium text-textPrimary">Lolos Standar Ramah Lingkungan</label>
            ...
            <div class="flex items-center justify-end gap-2 pt-4 border-t border-textTertiary/20">
                ...
                <button type="submit" x-bind:disabled="submitting"
                    ...
                    <span x-text="submitting ? 'Menyimpan...' : 'Simpan Usaha'"></span>
                </button>
            </div>
        </form>
    </div>

    ...
    <div @click.away="!submitting && (openDelete = false)" x-show="openDelete"
        ...
        <div class="p-6">
            <div class="flex items-center gap-3 text-red-500 mb-4">
                ...
                <h3 class="text-lg font-bold text-textPrimary">Konfirmasi Hapus Objek</h3>
            </div>

            <p class="text-sm text-textSecondary leading-relaxed">
                Apakah Anda yakin ingin menghapus data objek ini? Data yang terhubung mungkin akan ikut terhapus. Tindakan ini tidak dapat dibatalkan.
            </p>
        </div>
...
<div x-show="openDelete"
    ...
    <div @click.away="!submitting && (openDelete = false)" x-show="openDelete"
        ...
        x-transition:leave-start="opacity-100 scale-100 transform" x-transition:leave-end="opacity-0 scale-95 transform"
        class="w-full max-w-md overflow-hidden bg-secondary border border-textTertiary/30 shadow-xl rounded-xl"
        x-data="{ submitting: false }"> <div class="p-6">
            <div class="flex items-center gap-3 text-red-500 mb-4">
        ...
        <div class="flex items-center justify-end gap-2 px-6 py-4 bg-tertiary border-t border-textTertiary/20">
            ...
            <form :action="deleteRoute" method="POST" class="inline" @submit="submitting = true">
                ...
                <button type="submit" x-bind:disabled="submitting"
                    ...
                    <svg x-show="submitting" x-cloak class="animate-spin w-4 h-4 text-white" viewBox="0 0 24 24" fill="none">

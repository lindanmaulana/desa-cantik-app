    ...
    <div
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-textTertiary/20 bg-tertiary">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h3 class="text-lg font-bold text-textPrimary">Perbarui Wilayah</h3>
                    <p class="text-xs text-textSecondary">Perbarui data master teritori administratif.</p>
                </div>
            </div>
        ...
        <form :action="'{{ route('territories.update', ':id') }}'.replace(':id', data.id)" method="POST"
            class="p-6 space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="sub_village" name="sub_village" x-model="data.sub_village" required
            ...
            <div>
                ...
                <input type="text" id="area_name" name="area_name" x-model="data.area_name"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="rw"
                        ...
                        <span class="text-red-500">*</span></label>
                    <input type="text" id="rw" name="rw" required maxlength="5" x-model="data.rw"
                ...
                <div>
                    <label for="rt"
                        ...
                        <span class="text-red-500">*</span></label>
                    <input type="text" id="rt" name="rt" required maxlength="5" x-model="data.rt"

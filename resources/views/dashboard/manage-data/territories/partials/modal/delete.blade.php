    ...
    <div @click.away="!submitting && (openDelete = false)" x-show="openDelete"
        ...
        <div class="p-6">
            <div class="flex items-center gap-3 text-red-500 mb-4">
                ...
                <h3 class="text-lg font-bold text-textPrimary">Konfirmasi Hapus Wilayah</h3>
            </div>

            <p class="text-sm text-textSecondary leading-relaxed">
                Apakah Anda yakin ingin menghapus data wilayah ini? Data yang terhubung mungkin akan ikut terhapus atau
                menyebabkan gangguan data operasional warga. Tindakan ini tidak dapat dibatalkan.
            </p>
        </div>

        ...
        <form action="{{ route('territories.store') }}" method="POST" class="p-6 space-y-6" x-data="{ submitting: false }"
            ...
            <div>
                <label for="sub_village"
                    class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nama Dusun
            ...
            <div>
                <label for="area_name"
                    class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nama Spesifik /
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="rw"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nomor RW
                        <span class="text-red-500">*</span></label>
                    <input type="text" id="rw" name="rw" required maxlength="5"
                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                        oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                        placeholder="Contoh: 001"
                        class="w-full px-3 py-2 text-sm text-center transition-all border rounded-lg border-textTertiary/40 bg-tertiary text-textPrimary placeholder:text-textSecondary/50 focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                </div>

                <div>
                    <label for="rt"
                        class="block mb-1 text-xs font-semibold tracking-wider uppercase text-textSecondary">Nomor RT
                        <span class="text-red-500">*</span></label>

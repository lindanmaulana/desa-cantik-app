<x-layouts.dashboard>
    <div class="p-6 space-y-2 max-md:p-3" x-data="citizenData()">
        ...
        <div class="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
            <div>
                <h2 class="flex items-center gap-2 text-2xl font-bold text-gray-800 max-lg:text-xl max-md:text-lg">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('dashboard.manage-data.citizens') }}"
                    ...
                    <x-iconsax-lin-arrow-left class="mr-2 size-4 max-xl:mr-0" /> <span class="max-xl:hidden">Kembali ke
        ...
        <div class="flex flex-col gap-6">
            <article
                class="p-4 bg-white border border-t-8 shadow sm:p-6 lg:p-8 border-t-primary rounded-2xl sm:rounded-3xl">
                <div class="grid items-start grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div class="w-full space-y-4 md:col-span-2 lg:col-span-2">
                        <div class="space-y-1.5">
                            <div class="flex flex-wrap items-center gap-2">
                                <h4 class="max-w-full text-xl font-bold break-words md:text-2xl text-slate-800">
                                    {{ $citizen->full_name }}
                                </h4>
                                <span
                            ...
                            <div
                                class="flex flex-wrap items-center text-sm gap-x-2 gap-y-1 md:text-base text-slate-600">
                                <span x-show="openData"
                                    class="font-medium break-all text-slate-800">{{ $citizen->nik ?? '3208122005990004' }}</span>
                                <span x-show="!openData" class="inline-flex items-center"><x-vaadin-ellipsis-h
                                        class="size-4 text-slate-400" /></span>
                                <span class="hidden font-semibold text-slate-300 sm:inline">|</span>
                                <span
                        ...
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2.5 pt-2 border-t border-slate-50">
                            <div class="space-y-0.5">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">Jenis Kelamin
                                </dt>
                                <dd class="text-sm font-medium text-slate-800">{{ $citizen->gender->label() }}</dd>
                            </div>

                            <div class="space-y-0.5">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">Hubungan KK
                                </dt>
                                <dd class="text-sm font-medium text-slate-800">{{ $citizen->family_role->label() }}</dd>
                            </div>

                            <div class="space-y-0.5 sm:col-span-2">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">No KK
                                    (Keluarga)</dt>
                    ...
                    <div
                        class="grid w-full grid-cols-2 gap-3 pt-4 border-t md:col-span-3 lg:col-span-1 border-slate-100 md:border-t-0 md:pt-0 lg:h-full lg:content-start">
                        <div
                    ...
                    <hr class="my-2 md:col-span-3 lg:col-span-4 border-slate-100">

                    <section class="w-full md:col-span-3 lg:col-span-4">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-5 gap-x-6">
                            <div class="pb-2 space-y-1 border-b border-slate-50 sm:border-0 sm:pb-0">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">Tempat,
                                    Tanggal Lahir</dt>
                            ...
                            <div class="pb-2 space-y-1 border-b border-slate-50 sm:border-0 sm:pb-0">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">Status
                                    Pernikahan</dt>
                                <dd class="text-sm font-semibold text-slate-800">
                            ...
                            <div class="pb-2 space-y-1 border-b border-slate-50 sm:border-0 sm:pb-0">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">Alamat Detail
                                    Keluarga</dt>
                                <dd class="text-sm font-semibold break-words text-slate-800">
                            ...
                            <div class="pb-1 space-y-1 sm:pb-0">
                                <dt class="text-xs font-semibold tracking-wider uppercase text-slate-400">ID Referensi
                                    Sistem (UUID)</dt>
                                <div>
                                    <dd x-show="openData"

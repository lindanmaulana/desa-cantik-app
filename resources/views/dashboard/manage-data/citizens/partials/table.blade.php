        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm text-gray-700 divide-y divide-gray-100">
                ...
                <tr class="transition-colors hover:bg-gray-50/70">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900 max-md:px-3 max-md:py-2">
                        {{ $item->full_name }}
                    ...
                    <td class="px-6 py-4 font-medium text-gray-600 max-md:px-3 max-md:py-2">
                        @if($item->family)
                    ...
                    <td class="px-6 py-4 text-xs text-gray-500 max-md:px-3 max-md:py-2">

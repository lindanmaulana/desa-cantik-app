    ...
    <div class="w-full max-w-2xl overflow-hidden transition-all duration-300 transform scale-95 bg-white border border-gray-100 shadow-xl rounded-2xl">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h3 class="text-lg font-bold text-gray-800">Tambah Penduduk Baru</h3>
                    <p class="text-xs text-gray-500">Masukkan identitas lengkap warga desa baru.</p>
                </div>
            </div>
        ...
        <form action="{{ route('citizens.store') }}" method="POST" class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
            @csrf
            ...
            <div class="flex items-start gap-2 p-3 text-xs border rounded-lg bg-amber-50 border-amber-100 text-amber-700">
                ...
                <p>Pastikan NIK terdiri dari 16 digit yang unik dan valid. Penyelarasan NIK sangat penting untuk modul-modul turunan seperti Sosial Ekonomi (Bansos) dan MSME (UMKM).</p>
            </div>

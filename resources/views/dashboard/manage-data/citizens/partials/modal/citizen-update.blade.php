<div x-show="citizen.openUpdate" class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto transition-opacity duration-300 bg-gray-900 bg-opacity-50 backdrop-blur-sm">
    <div class="w-full max-w-3xl overflow-hidden transition-all duration-300 transform scale-95 bg-white border border-gray-100 shadow-xl rounded-2xl">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50">
            ...
            <button @click="citizen.openUpdate = false" class="p-1 text-gray-400 transition-colors rounded-lg hover:text-gray-600 hover:bg-gray-100">
        ...
        <form action="{{ route('citizens.store') }}" method="POST" class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="update_id_number" name="id_number" required maxlength="16" minlength="16" x-model="citizen.data.id_number" placeholder="16 digit NIK"
                ...
                <div>
                    ...
                    <input type="text" id="update_full_name" name="full_name" required x-model="citizen.data.full_name" placeholder="Contoh: Budi Santoso"
                        class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="update_birth_place" name="birth_place" required x-model="citizen.data.birth_place" placeholder="Contoh: Cirebon"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                    </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="update_blood_type" name="blood_type" maxlength="5" x-model="citizen.data.blood_type" placeholder="Contoh: O, AB"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-2 pt-4 border-t border-gray-100">
                <button type="button" @click="citizen.openUpdate = false" class="px-4 py-2 text-sm font-medium text-gray-700 transition-colors bg-white border border-gray-200 rounded-lg hover:bg-gray-50 focus:outline-none">
                    Batal
                </button>

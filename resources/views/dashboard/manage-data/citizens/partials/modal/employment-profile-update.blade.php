<div x-show="employmentProfile.openUpdate"
    ...
    <div
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-textTertiary/10 bg-tertiary">
            ...
            <button @click="employmentProfile.openUpdate = false"
        ...
        <!-- Form Update Data -->
        <form action="{{ route('employment-profile.update', $citizen) }}" method="POST"
            class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            @csrf
            @method('PUT')

            <!-- Logika Reactivity State dengan Alpine.js -->
            <div class="space-y-4" x-data记录="{ isWelfare: '0' }" x-init="isWelfare = employmentProfile.data.is_welfare_recipient ? '1' : '0';
            ...
            $watch('isWelfare', value => {
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="update_occupation" name="occupation" required
                            x-model="employmentProfile.data.occupation" placeholder="Contoh: Petani, Swasta"
                    ...
                    <div>
                        ...
                        <select id="update_job_sector" name="job_sector" required
                            x-model="employmentProfile.data.job_sector"
                ...
                <!-- Baris 2: Hubungan Kerja & Pendapatan Bulanan -->
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        <label for="update_employment_status"
                        ...
                        <select id="update_employment_status" name="employment_status" required
                            x-model="employmentProfile.data.employment_status"
                            class="w-full px-3 py-2 text-sm transition-all border border-textTertiary/40 rounded-lg bg-tertiary text-textPrimary focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                    ...
                    <div>
                        <label for="update_monthly_income"
                            class="block mb-1 text-xs font-semibold tracking-wider text-textSecondary uppercase">Pendapatan
                            Bulanan (Rupiah)</label>
                        <input type="number" id="update_monthly_income" name="monthly_income"
                            x-model="employmentProfile.data.monthly_income" placeholder="0"
                            class="w-full px-3 py-2 text-sm transition-all border border-textTertiary/40 rounded-lg bg-tertiary text-textPrimary placeholder:text-textTertiary focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                    </div>
                </div>

                <!-- Baris 3: Kesejahteraan & Penerima Bansos -->
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        <label for="update_economic_status"
                        ...
                        <select id="update_economic_status" name="economic_status" required
                            x-model="employmentProfile.data.economic_status"
                            class="w-full px-3 py-2 text-sm transition-all border border-textTertiary/40 rounded-lg bg-tertiary text-textPrimary focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                    ...
                    <div>
                        <label for="update_is_welfare_recipient"
                        ...
                        <select id="update_is_welfare_recipient" name="is_welfare_recipient" x-model="isWelfare"
                            required
                            class="w-full px-3 py-2 text-sm transition-all border border-textTertiary/40 rounded-lg bg-tertiary text-textPrimary focus:outline-none focus:bg-secondary focus:border-primary focus:ring-1 focus:ring-primary">
                ...
                <div x-show="isWelfare === '1'" x-transition class="p-3 border rounded-lg bg-amber-50 border-amber-100">
                    <label for="update_assistance_type"
                    ...
                    <input type="text" id="update_assistance_type" name="assistance_type"
                        :required="isWelfare === '1'" x-model="employmentProfile.data.assistance_type"
                        placeholder="Contoh: PKH, BPNT, BLT-DD"
            ...
            <div class="flex items-center justify-end gap-2 pt-4 border-t border-textTertiary/10">
                <button type="button" @click="employmentProfile.openUpdate = false"

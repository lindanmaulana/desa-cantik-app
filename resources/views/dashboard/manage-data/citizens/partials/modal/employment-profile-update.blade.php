<div x-show="employmentProfile.openUpdate" class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto transition-opacity duration-300 bg-gray-900 bg-opacity-50 backdrop-blur-sm">
    <div class="w-full max-w-3xl overflow-hidden transition-all duration-300 transform scale-95 bg-white border border-gray-100 shadow-xl rounded-2xl">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50">
            ...
            <button @click="employmentProfile.openUpdate = false" class="p-1 text-gray-400 transition-colors rounded-lg hover:text-gray-600 hover:bg-gray-100">
                <x-heroicon-o-x-mark class="w-5 h-5" />
            </button>
        </div>

        <form action="{{ route('employment-profile.update', $citizen) }}" method="POST" class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            @csrf
            @method('PUT')

            <div class="space-y-4" x-data="{ isWelfare: '0' }"
                x-init="isWelfare = employmentProfile.data.is_welfare_recipient ? '1' : '0';
                
                $watch('employmentProfile.data.is_welfare_recipient', value => {
                    isWelfare = value ? '1' : '0';
                });

                $watch('isWelfare', value => {
                    employmentProfile.data.is_welfare_recipient = (value === '1');
                    if (value === '0') employmentProfile.data.assistance_type = '';
                });">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="update_occupation" name="occupation" required x-model="employmentProfile.data.occupation" placeholder="Contoh: Petani, Swasta"
                    ...
                    <div>
                        ...
                        <select id="update_job_sector" name="job_sector" required x-model="employmentProfile.data.job_sector"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <select id="update_employment_status" name="employment_status" required x-model="employmentProfile.data.employment_status"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="update_monthly_income" name="monthly_income" x-model="employmentProfile.data.monthly_income" placeholder="0"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <select id="update_economic_status" name="economic_status" required x-model="employmentProfile.data.economic_status"
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                    ...
                    <div>
                        ...
                        <select id="update_is_welfare_recipient" name="is_welfare_recipient" x-model="isWelfare" required
                            class="w-full px-3 py-2 text-sm transition-all border border-gray-200 rounded-lg bg-gray-50/50 focus:outline-none focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500">
                ...
                <div x-show="isWelfare === '1'" x-transition class="p-3 border rounded-lg bg-amber-50 border-amber-100">
                    ...
                    <input type="text" id="update_assistance_type" name="assistance_type" :required="isWelfare === '1'" x-model="employmentProfile.data.assistance_type" placeholder="Contoh: PKH, BPNT, BLT-DD"
            ...
            <div class="flex items-center justify-end gap-2 pt-4 border-t border-gray-100">
                <button type="button" @click="employmentProfile.openUpdate = false" class="px-4 py-2 text-sm font-medium text-gray-700 transition-colors bg-white border border-gray-200 rounded-lg hover:bg-gray-50 focus:outline-none">
                    Batal
                </button>

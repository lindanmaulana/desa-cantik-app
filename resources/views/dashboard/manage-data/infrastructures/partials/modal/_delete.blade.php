{{-- Modal Konfirmasi Hapus Data Infrastruktur --}}
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm leading-relaxed text-textSecondary">
                        Apakah Anda yakin ingin menghapus data infrastruktur <span class="font-semibold text-textPrimary" x-text="infrastructure.name"></span> secara permanen? Tindakan ini akan memutus keterkaitan data logistik, laporan pemeliharaan, serta dokumentasi operasional yang terhubung. <span class="font-semibold text-red-500">Aksi ini tidak dapat dibatalkan</span>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t bg-tertiary/40 border-textTertiary/20">
            ...
            <form :action="deleteRoute" method="POST" class="inline" @submit="submitting = true">
                ...
                <button type="submit"
                    ...
                    <span x-text="submitting ? 'Memproses...' : 'Ya, Hapus Aset'"></span>
                </button>
            </form>
        </div>
    </div>

@if(request('type'))
<div x-data="tableComponent('table-village-demographics', {{ Js::from($tableAggregateVillageData) }})" x-init="initTable()" class="p-4 space-y-4 bg-white border border-gray-100 shadow-sm sm:p-6 rounded-2xl sm:rounded-3xl">

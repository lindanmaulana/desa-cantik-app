<div class="p-4 bg-white border border-gray-100 shadow-sm sm:p-8 rounded-2xl sm:rounded-3xl">
    ...
    <div class="flex flex-wrap gap-2 sm:gap-3">
        <a href="{{ route('dashboard.statistics.demograph', ['type' => $demographicsType::AGE_GROUP->value]) }}"
            class="max-md:w-full">
        ...
        <a href="{{ route('dashboard.statistics.demograph', ['type' => $demographicsType::MARITAL_STATUS->value]) }}"
            class="max-md:w-full">
        ...
        <a href="{{ route('dashboard.statistics.demograph', ['type' => $demographicsType::TERRITORY->value]) }}"
            class="max-md:w-full">
        ...
        <a href="{{ route('dashboard.statistics.demograph', ['type' => $demographicsType::CITIZEN_STATUS->value]) }}"
            class="max-md:w-full">

<div class="flex items-center gap-3 pb-4 mb-6 border-b sm:gap-4 sm:pb-6 sm:mb-10 border-slate-200">
    ...
    <div>
        <h3 class="text-lg font-bold sm:text-xl text-slate-800">Infrastruktur</h3>
        <p class="text-sm sm:text-lg text-slate-600">Analisis aggregate infrastruktur dan fasilitas fisik Desa Sukaraja</p>
    </div>
</div>
...
<div class="space-y-4" x-show="!isGenerated" x-transition:leave="transition ease-in duration-300"
    ...
    <div
        ...
        <div class="flex flex-col items-center justify-center max-w-md gap-2 text-center">
            ...
            <h4 class="text-lg font-bold sm:text-xl text-slate-800">Hitung Agregat Infrastruktur</h4>
            ...
            <a href="{{ route('dashboard.statistics.infrastructure', ['type' => $infrastructureType::FACILITY_TYPE->value]) }}"

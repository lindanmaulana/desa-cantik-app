<div class="p-8 bg-white border border-gray-100 shadow-sm rounded-3xl">
    ...
    <div class="flex flex-wrap gap-3">
        ...
        $icon = match($type) {
            ...
            $socialType::BLOOD_TYPE => 'ri-drop-line',
            $socialType::DISABILITY => 'ri-accessibility-fill',
            $socialType::PREGNANCY => 'ri-parent-line',
            $socialType::FAMILY_PLANNING => 'ri-team-line',
            $socialType::BPJS_STATUS => 'ri-heart-pulse-line',
        ...
        <a href="{{ route('dashboard.statistics.social', ['type' => $type->value, 'rw' => request('rw'), 'rt' => request('rt')]) }}"
            class="max-md:w-full">

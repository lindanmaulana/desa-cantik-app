<x-layouts.dashboard>
    <div class="space-y-6">
        <div class="flex items-center gap-4 pb-6 mb-10 border-b border-slate-200">
            <x-ri-heart-pulse-line class="p-3 rounded-md size-12 bg-primary/20 text-primary" />
            <div>
                <h3 class="text-xl font-bold">Sosial</h3>
                <p class="text-slate-600">Analisis sosial & kesehatan Desa Sukaraja</p>
            </div>
        </div>

        <div class="flex items-center justify-center border-2 border-dashed rounded-2xl border-slate-300 min-h-96">
            <div class="flex flex-col items-center justify-center gap-2">
                <x-ri-heart-pulse-line class="p-3 mb-4 rounded-md size-16 bg-primary/20 text-primary" />
                <h4 class="text-xl font-bold">Hitung Agregat Sosial</h4>
                <p class="max-w-md mb-4 text-base text-center text-slate-600">Sistem akan memproses seluruh data untuk menghasilkan statistik Sosial. Proses ini hanya dilakukan sekali per sesi.</p>

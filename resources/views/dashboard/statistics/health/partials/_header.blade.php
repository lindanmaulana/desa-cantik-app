<div class="flex items-center gap-3 pb-4 mb-6 border-b sm:gap-4 sm:pb-6 sm:mb-10 border-textTertiary/30">
    ...
    <div>
        ...
        <p class="text-sm sm:text-lg text-textSecondary">Analisis agregat kesehatan
...
<div class="space-y-4" x-show="!isGenerated">
    <div
        ...
        <form action="{{ route('dashboard.statistics.health') }}" method="GET" @submit="isGenerating = true"
        ...
        <div x-show="isGenerating" x-cloak x-transition:enter="transition ease-out duration-300"
            ...
            <div class="w-full max-w-xs space-y-2 text-center">
                ...
                <p class="text-xs font-medium text-textSecondary animate-pulse">Mengalkulasi profil kesehatan, KB, &
                    gizi balita warga...</p>
            </div>
        </div>
